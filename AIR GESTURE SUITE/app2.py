...
# st.write("Control your system with gestures!")

# gesture_controller = GestureController()

# # Create a checkbox to activate/deactivate gesture control
# activate_controller = st.checkbox("Activate Gesture Control")

# # Display a placeholder for the video feed
# video_placeholder = st.empty()

# if activate_controller:
#     st.info("Gesture control activated! Press the checkbox again to stop.")
#     try:
#         # Loop through frames using the generator from GestureController
#         for frame in gesture_controller.start():
...
# else:
#     st.warning("Activate the checkbox to start gesture control.")
...
# gc1.start()
# # Gesture part of the code unchanged; add it here

# Gesture Handling Classes: 
# Gest(IntEnum), HLabel(IntEnum), HandRecog, Controller
# Add the gesture recognition and controller classes code from your codebase here

# Streamlit implementation
def main():
    st.title("Gesture Controlled Interface")
    run = st.checkbox('Run Gesture Controller')
    ...
    while run:
        ...
        if results.multi_hand_landmarks:
            ...
            gest_name = hand_minor.get_gesture()
            if gest_name == Gest.PINCH_MINOR:
                Controller.handle_controls(gest_name, hand_minor.hand_result)
            else:
                gest_name = hand_major.get_gesture()
                Controller.handle_controls(gest_name, hand_major.hand_result)
